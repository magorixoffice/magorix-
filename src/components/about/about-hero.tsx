  ...
  return (
    ...
    >
      ...
      <Container className="relative py-section-sm md:py-section lg:py-section-lg">
        ...
        >
          We build calm software for ambitious schools
        </h1>
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-foreground/65 md:mt-8 md:text-lg">
          Magorix exists to connect institutions, families, and learners—without
          the noise. Here&apos;s how we got here, what we believe, and who makes
          it happen.
        </p>
      </Container>
    </section>
